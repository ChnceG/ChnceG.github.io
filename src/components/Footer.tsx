    ...
    return (
        <footer className="flex flex-col bottom-0 w-full p-4">
            ...
            <div className="flex justify-center gap-4">
                <a href="mailto:cbgrandy@gmail.com" className="hover:scale-105 duration-300 underline flex">
                    <img src={emailIcon} alt="Email Icon" className="w-6 h-6 mr-2" />
                    cbgrandy@gmail.com
                </a>
                <a href="https://github.com/chnceg" className="hover:scale-105 duration-300 underline flex">
